...
export const ANSWER_CONTAINER = "answer-container";
export const ANSWER_WRAPPER = "answer-wrapper";
export const RESULT_CENTERED = "result-centered";
export const TEST_AGAIN_ID = "test-again";
